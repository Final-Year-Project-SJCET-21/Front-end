            ...
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full min-h-screen mb-10 shadow-lg rounded">
              <div className=" flex items-center justify-center ">
                <div className="bg-white p-4 rounded w-full">
                  ...
                  {role=="T"?(
                    <Popup 
                    trigger={<button className=" max-auto  border border-indigo-500 text-indigo-500 active:bg-blueGray-600   text-sm font-semibold  px-3 py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1  ease-linear transition-all duration-150 hover:bg-indigo-500 hover:text-white"> Upload</button>} 
                        ...
                        <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                          <div className="space-y-1 text-center">
                            ...
                            <div class="mt-3 text-right">
                              ...
                              >Close</button>
                              <button 
                              class="ml-2 h-10 w-32 bg-purple-800 rounded text-white hover:bg-blue-700"
